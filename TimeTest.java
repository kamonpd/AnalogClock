...
public class TimeTest {
    ...
    public static void main(final String[] args) {
        ...
        final DateTimeFormatter dateformat = DateTimeFormatter.ofPattern("dd/M/yyyy");
        final String time = dateTime.format(timeformat);
        final String date = dateTime.format(dateformat);

        final String[] spittime = time.split(":");
        final String[] spitdate = date.split("/");
        
        day = Integer.parseInt(spitdate[0]) ;
        month = Integer.parseInt(spitdate[1]) ;
        year = Integer.parseInt(spitdate[2]) ;
        
        h = Integer.parseInt(spittime[0]) ;
        m = Integer.parseInt(spittime[1]) ;
        s = Integer.parseInt(spittime[2]);
